...
/*  template< typename InputIt >
  ...
  template< typename Key, typename Value, typename Compare >
  typename BinarySearchTree< Key, Value, Compare >::iterator
  RotatableBinarySearchTree< Key, Value, Compare >::end() noexcept
  {
    return bst_.end();
  }
  template< typename Key, typename Value, typename Compare >
  ...
  template< typename Key, typename Value, typename Compare >
  typename BinarySearchTree< Key, Value, Compare >::iterator
  RotatableBinarySearchTree< Key, Value, Compare >::last() noexcept
  {
    return bst_.last();
  }
  template< typename Key, typename Value, typename Compare >
  ...
  template< typename Key, typename Value, typename Compare >
  typename BinarySearchTree< Key, Value, Compare >::iterator
  RotatableBinarySearchTree< Key, Value, Compare >::begin() noexcept
  {
    return bst_.begin();
  }
  template< typename Key, typename Value, typename Compare >
