...
namespace romanovich
{
  ...
  public:
    ...
    void rotateLeftLeft(tree_node_t *node);
    void rotateRightRight(tree_node_t *node);
    void printNode(const tree_node_t *node, bool isLeft, const std::string &prefix) const;
  private:
    BinarySearchTree< Key, Value, Compare > bst_;
  };
  template< typename Key, typename Value, typename Compare >
  void RotatableBinarySearchTree< Key, Value, Compare >::printNode(const tree_node_t *node, bool isLeft,
  ...
  template< typename Key, typename Value, typename Compare >
  void RotatableBinarySearchTree< Key, Value, Compare >::rotateLeftLeft(tree_node_t *node)
  {
  ...
  template< typename Key, typename Value, typename Compare >
  void RotatableBinarySearchTree< Key, Value, Compare >::rotateRightRight(tree_node_t *node)
  {
